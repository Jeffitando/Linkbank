...
public class Comprovante_boleto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_comprovante_boleto);
        ...
        ib_voltar_boletos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent3 = new Intent(getApplicationContext(), Pagamentos.class);
                finish();
