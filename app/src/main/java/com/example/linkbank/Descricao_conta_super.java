...
public class Descricao_conta_super extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_descricao_conta_super);
        ...
        btn_avancar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentChave = new Intent(getApplicationContext(), Solicitar_mudar_tipo_conta_super.class);
                finish();
                startActivity(intentChave);
            }
        });
