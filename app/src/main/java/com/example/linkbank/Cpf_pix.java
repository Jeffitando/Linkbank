...
public class Cpf_pix extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cpf_pix);
                ...
                if (snapshot.exists()) {
                    ...
                    for (DataSnapshot ds : snapshot.getChildren()) {
                        ...
                        if (usuario != null) {
                            ...
                            Toast.makeText(Cpf_pix.this, "Nenhum usuário cadastrado no banco", Toast.LENGTH_SHORT).show();
                        }
    ...
    private void validaDados(){
        String cpf = etDat.getText().toString();
        ...
        if (!cpf.isEmpty()){
                    ...
                    for ( int i = 0; i < usuarioList.size(); i++){
                        if (usuarioList.get(i).getPixCpf().equals(cpf)){
