...
public class Email_pix extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_email_pix);
                ...
                if (snapshot.exists()) {
                    ...
                    for (DataSnapshot ds : snapshot.getChildren()) {
                        ...
                        if (usuario != null) {
                            ...
                            Toast.makeText(Email_pix.this, "Nenhum usuário cadastrado no banco", Toast.LENGTH_SHORT).show();
                        }
    ...
    private void validaDados(){
        String email = etDat.getText().toString();
        ...
        if (!email.isEmpty()){
            ...
            for ( int i = 0; i < usuarioList.size(); i++){
                if (usuarioList.get(i).getPixEmail().equals(email)){
