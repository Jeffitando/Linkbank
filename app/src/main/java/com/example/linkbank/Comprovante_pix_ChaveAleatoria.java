...
public class Comprovante_pix_ChaveAleatoria extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_comprovante_pix_chave_aleatoria);
        ...
        btnContinuar.setOnClickListener(view -> {
            Intent intentHome = new Intent(Comprovante_pix_ChaveAleatoria.this, Home.class);
